...
public class RoundRoomFragmentmacAdapter extends BaseQuickAdapterEx<RoomList, BaseViewHolder> {
    private Context context;
    private List<RoundsRecordCount> roundsRecordCounts = new ArrayList<>();

    public RoundRoomFragmentmacAdapter(List<RoomList> data, Context context, List<RoundsRecordCount> roundsRecordCounts) {
        super(R.layout.item_round_room_mac_fragment, data);
