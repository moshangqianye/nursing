...
//政策新闻适配器
public class UrbanLowFujianShenqingDetailBianjiAdapter extends BaseQuickAdapterEx<UrbanLowFujianBean.Jiuzhuxiang.Shenqingxiang, BaseViewHolder> {
    ...
    public UrbanLowFujianShenqingDetailBianjiAdapter(List<UrbanLowFujianBean.Jiuzhuxiang.Shenqingxiang> data, int type, Context context, UrbanLowFamilyFragmentPresenter mPresenter, UrbanLowFujianBean.Jiuzhuxiang itemJiuzhuxiang, String mybatchNo, UrbanFuJianBianjiFragment urbanFuJianFragment) {
