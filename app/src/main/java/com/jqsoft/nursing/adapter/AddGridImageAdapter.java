 ...
 * data：16/7/27
 */
public class AddGridImageAdapter extends
        RecyclerView.Adapter<AddGridImageAdapter.ViewHolder> {
    ...
    public AddGridImageAdapter(Context context) {
        mInflater = LayoutInflater.from(context);

    }

    public AddGridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
        mInflater = LayoutInflater.from(context);
