...
//政策新闻适配器
public class UrbanLowFujianShenqingshuBianjiAdapter extends BaseQuickAdapterEx<UrbanLowFujianBean.Jiuzhuxiang, BaseViewHolder> {
    ...
    private UrbanFuJianBianjiFragment urbanFuJianFragment;
    ...
    public UrbanLowFujianShenqingDetailBianjiAdapter myAdapter2;
    ...
    public interface PaizhaoListener {
        public void onPaizhaoClick(String s, String itemid,int myCount);
    }
    ...
    List<UrbanLowFujianBean.Jiuzhuxiang> mydata = new ArrayList<>();

    public UrbanLowFujianShenqingshuBianjiAdapter(List<UrbanLowFujianBean.Jiuzhuxiang> data, int type, Context context,
                                                  FullyLinearLayoutManager fullyLinearLayoutManager1, UrbanLowFamilyFragmentPresenter mPresenter, String mybatchNo, UrbanFuJianBianjiFragment urbanFuJianFragment ) {
    ...
    protected void convert(final BaseViewHolder helper, final UrbanLowFujianBean.Jiuzhuxiang item) {
       ...
       myDetailAdapter = new UrbanLowFujianShenqingDetailBianjiAdapter(new ArrayList<UrbanLowFujianBean.Jiuzhuxiang.Shenqingxiang>(), TYPE_MULTIPLE_LINE,context,mPresenter,item,mybatchNo, urbanFuJianFragment);
    ...
    //    rv_shengqingdetail.setLayoutManager(new FullyLinearLayoutManager(context));
        ...
        iv_photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPaizhaoListener.onPaizhaoClick(Util.trimString(item.getFileCode()),itemid, mydata.size());
            }
        });
    }
