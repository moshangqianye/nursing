 ...
 * 签约服务评价适配器
 */
public class SignServiceAssessAdapter extends BaseQuickAdapterEx<MyFindDoDiscovertBean, BaseViewHolder> {
    private Context context;

    public SignServiceAssessAdapter(List<MyFindDoDiscovertBean> data,Context context) {
        super(R.layout.item_find_dodiscover, data);
        this.context=context;
    }

    @Override
    protected void convert(final BaseViewHolder helper, final MyFindDoDiscovertBean item) {
