...
//我的收藏适配器
public class HelpListAdapter extends BaseQuickAdapterEx<HelpListBean, BaseViewHolder> {
    ...
    public HelpListAdapter(List<HelpListBean> data, int type) {
...
//        this.context=context;
    ...
    @Override
    protected void convert(final BaseViewHolder helper, final HelpListBean item) {
