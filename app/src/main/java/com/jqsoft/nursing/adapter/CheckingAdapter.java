 ...
 * 签约服务评价适配器
 */
public class CheckingAdapter extends BaseQuickAdapterEx<HouseCheckingBean, BaseViewHolder> {
    private Context context;

    public CheckingAdapter(List<HouseCheckingBean> data, Context context) {
    ...
    @Override
    protected void convert(final BaseViewHolder helper, final HouseCheckingBean item) {
...
//        GlideUtils.loadImage(imageUrl, (ImageView) helper.getView(R.id.iv_title));
        helper.setText(R.id.username, "户主: " + Util.trimString(item.getSAREANAME()));
