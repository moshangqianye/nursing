...
public class ReMindeAdapter extends BaseQuickAdapterEx<ExecutionProjectsResultBean, BaseViewHolder> {
    private Context context;

    public ReMindeAdapter(List<ExecutionProjectsResultBean> data) {
