 ...
 * data：16/7/27
 */
public class AddVideoImageAdapter extends
        RecyclerView.Adapter<AddVideoImageAdapter.ViewHolder> {
    ...
    public AddVideoImageAdapter(Context context) {
        mInflater = LayoutInflater.from(context);

    }

    public AddVideoImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
        mInflater = LayoutInflater.from(context);
