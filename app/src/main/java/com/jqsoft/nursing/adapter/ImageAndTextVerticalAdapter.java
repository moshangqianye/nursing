...
public class ImageAndTextVerticalAdapter extends BaseQuickAdapterEx<ImageAndTextBean, BaseViewHolder> {
    public ImageAndTextVerticalAdapter(List data) {
        super(R.layout.layout_image_and_text_item, data);
    }
