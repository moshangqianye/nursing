 ...
 */
public class ModifyServerSituationAdapter extends BaseAdapter implements SmoothRadioGroup.OnCheckedChangeListener {
  ...
  //  private List<ExecuProjectActivity.User> users;
    ...
    private List<ModifyExecuedBeanList> users;
   ...
   /* public ServerSituationAdapter(Context context, List<ExecuProjectActivity.User> objects) {
    ...
    public ModifyServerSituationAdapter(Context context, List<ModifyExecuedBeanList> objects) {
        this.ctx = context;
        this.users = objects;
        //别忘了初始化inflater
        inflater = LayoutInflater.from(ctx);
    ...
    @Override
    public ModifyExecuedBeanList getItem(int position) {
  ...
  /*  @Override
    ...
    public int getItemViewType(int position) {
        //获取当前布局的数据
        ModifyExecuedBeanList u = users.get(position);
        //哪个字段不为空就说明这是哪个布局
        //比如第一个布局只有item1_str这个字段，那么就判断这个字段是不是为空，
        //如果不为空就表明这是第一个布局的数据
        //根据字段是不是为空，判断当前应该加载的布局
        ...
        if (convertView == null) {
                ...
                case TYPE1:
                    ...
                    holder1.rb_had1.setOnClickListener(new View.OnClickListener() {
                      ...
                      //      Toast.makeText(ctx,"无:"+ had1, Toast.LENGTH_SHORT).show();
                            ...
                            ((MotifyExecuActivity)ctx).saveHad1(position, had1);
                        }
                    });
                    ...
                    holder1.rb_had2.setOnClickListener(new View.OnClickListener() {
                      ...
                      //      Toast.makeText(ctx,"有:"+ had2, Toast.LENGTH_SHORT).show();
                            ...
                            ((MotifyExecuActivity)ctx).saveHad1(position, had2);
                        }
                    });
                   ...
                   /* holder2.rb_abnormal1.setOnCheckedChangeListener(this);
                    ...
                    holder2.rb_abnormal1.setOnClickListener(new View.OnClickListener() {
                     ...
                     //       Toast.makeText(ctx,"无异常:"+ abnormal1, Toast.LENGTH_SHORT).show();
                            ...
                            ((MotifyExecuActivity)ctx).saveAbnormalData(position, abnormal1);
                        }
                    });
                    ...
                    holder2.rb_abnormal2.setOnClickListener(new View.OnClickListener() {
                     ...
                     //       Toast.makeText(ctx,"有异常:"+ abnormal2, Toast.LENGTH_SHORT).show();
                            ...
                            ((MotifyExecuActivity)ctx).saveAbnormalData(position, abnormal2);
                        }
                    });
                ...
                case TYPE3:
                    ...
                    holder3.rb_plus1.setOnClickListener(new View.OnClickListener() {
                       ...
                       //     Toast.makeText(ctx,"-:"+ plus1, Toast.LENGTH_SHORT).show();
                            ...
                            ((MotifyExecuActivity)ctx).savePlus3(position, plus1);
                        }
                    });
                    ...
                    holder3.rb_plus2.setOnClickListener(new View.OnClickListener() {
                       ...
                       //     Toast.makeText(ctx,"+:"+ plus2, Toast.LENGTH_SHORT).show();
                            ...
                            ((MotifyExecuActivity)ctx).savePlus3(position, plus2);
                        }
                    });
                ...
                case TYPE4:
                    ...
                    holder4.rb_plusplus1.setOnClickListener(new View.OnClickListener() {
                     ...
                     //       Toast.makeText(ctx,"-:"+ plusplus4, Toast.LENGTH_SHORT).show();
                            ...
                            ((MotifyExecuActivity)ctx).savePlusplus4(position, plusplus1);
                        }
                    });
                    ...
                    holder4.rb_plusplus2.setOnClickListener(new View.OnClickListener() {
                      ...
                      //      Toast.makeText(ctx,"+:"+ plusplus2, Toast.LENGTH_SHORT).show();
                            ...
                            ((MotifyExecuActivity)ctx).savePlusplus4(position, plusplus2);
                        }
                    });
                    holder4.rb_plusplus3.setOnClickListener(new View.OnClickListener() {
                     ...
                     //       Toast.makeText(ctx,"++:"+ plusplus3, Toast.LENGTH_SHORT).show();
                            ...
                            ((MotifyExecuActivity)ctx).savePlusplus4(position, plusplus3);
                        }
                    });
                    holder4.rb_plusplus4.setOnClickListener(new View.OnClickListener() {
                      ...
                      //      Toast.makeText(ctx,"+++:"+ plusplus4, Toast.LENGTH_SHORT).show();
                            ...
                            ((MotifyExecuActivity)ctx).savePlusplus4(position, plusplus4);
                        }
                    });
            ...
            switch (type) {
                case TYPE1:
                    ...
                    String sHadCheck = users.get(position).getValue();
                    if(sHadCheck.equals("1")){
                        holder1.rb_had1.setChecked(true);

                    }else if(sHadCheck.equals("2")){
                        holder1.rb_had2.setChecked(true);
                    }

                    break;
                case TYPE2:
                    holder2.item2_tv.setText(users.get(position).getZbmc()+":");
                    String sabnormalCheck = users.get(position).getValue();
                    if(sabnormalCheck.equals("1")){
                        holder2.rb_abnormal1.setChecked(true);
                    }else if(sabnormalCheck.equals("2")){
                        holder2.rb_abnormal2.setChecked(true);
                    }
                    break;
                case TYPE3:
                    holder3.item3_tv.setText(users.get(position).getZbmc()+":");
                    String spluCheck = users.get(position).getValue();
                    if(spluCheck.equals("1")){
                        holder3.rb_plus1.setChecked(true);
                    }else if(spluCheck.equals("2")){
                        holder3.rb_plus2.setChecked(true);
                    }
                    break;
                case TYPE4:
                    holder4.item4_tv.setText(users.get(position).getZbmc()+":");
                    String splusplusCheck = users.get(position).getValue();
                    if(splusplusCheck.equals("1")){
                        holder4.rb_plusplus1.setChecked(true);
                    }else if(splusplusCheck.equals("2")){
                        holder4.rb_plusplus2.setChecked(true);
                    }else if(splusplusCheck.equals("3")){
                        holder4.rb_plusplus3.setChecked(true);
                    }else if(splusplusCheck.equals("4")){
                        holder4.rb_plusplus4.setChecked(true);
                    }
                    break;
                case TYPE5:
                    holder5.item5_tv.setText(users.get(position).getZbmc()+":");
                    holder5.tv_unit5.setText(users.get(position).getUnit());
                    holder5.et_info5.setText(users.get(position).getValue());
                    break;
                case TYPE6:
                    holder6.item6_tv.setText(users.get(position).getZbmc()+":");
                    holder6.tv_unit.setText(users.get(position).getUnit());
                    holder6.et_info.setText(users.get(position).getValue());
    ...
    class TextSwitcher6 implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            String s1 =mHolder.et_info.getText().toString();
            ((MotifyExecuActivity)ctx).saveEditData(position, s.toString());
        }
    }
    ...
    class TextSwitcher2 implements TextWatcher {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            ((MotifyExecuActivity)ctx).saveAbnormalData(position, s.toString());
        }
    ...
    class TextSwitcher5 implements TextWatcher {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            ((MotifyExecuActivity)ctx).saveEditData5(position, s.toString());
        }
