...
public class ArticleAdapter extends GroupRecyclerAdapter<String, Article> {
    ...
    private static String SchedulElders;

    public String getContent() {
        return Scheduling;
    }

    public void setContent(String Scheduling,String SchedulElders) {
        this.Scheduling = Scheduling;
        this.   SchedulElders=SchedulElders;
        map.put("排班安排", create(0));
...
//        titles.add("最高评论");
    ...
    private static Article createContent(String content) {
