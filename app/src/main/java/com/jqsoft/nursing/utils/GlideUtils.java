...
import com.jqsoft.nursing.webview.CommonUtils;
...
public class GlideUtils {
    ...
    public static void loadImageNew(String url, ImageView imageView){
        Glide.with(Utils.getContext())
                .load(url)
                .crossFade(1500)
                .error(R.mipmap.icon_wutu)
                .into(imageView);
    }

    public static void loadImageNewFamily(String url, ImageView imageView){
        Glide.with(Utils.getContext())
                .load(url)
                .crossFade(1500)
    ...
    public static void loadImageWithPlaceholderAndError(ImageView imageView, String url, int placeholderResourceId, int errorResourceId) {
        Glide.with(imageView.getContext())
                .load(url)
