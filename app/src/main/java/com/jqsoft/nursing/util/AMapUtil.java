...
//	}
//
//	public static com.amap.api.maps2d.model.LatLng convertToLatLng2d(LatLonPoint  latLonPoint){
//		return new com.amap.api.maps2d.model.LatLng(latLonPoint.getLatitude(), latLonPoint.getLongitude());
//	}
//
//	/**
