...
public class NotInputDialog {
    ...
    public NotInputDialog(Context context) {
        this.mContext = context;
    }

    public NotInputDialog builder() {
     ...
     * @return
     */
    public NotInputDialog setTitle(String title) {
        mIsShowTitle = true;
    ...
    public NotInputDialog setTitle(int titleResId) {
        mIsShowTitle = true;
     ...
     * @return
     */
    public NotInputDialog setContentMsg(String msg) {
    ...
    public NotInputDialog setContentMsg(int msgResId) {
        setContentMsg(mContext.getString(msgResId));
        return this;
    }

    public NotInputDialog setCancelable(boolean cancel) {
        mDialog.setCancelable(cancel);
        return this;
    }

    public NotInputDialog setCanceledOnTouchOutside(boolean cancel) {
     ...
     * @return
     */
    public NotInputDialog setPositiveBtn(String text, final OnPositiveListener onPositiveListener) {
     ...
     * @return
     */
    public NotInputDialog setNegativeBtn(String text, final OnNegativeListener onNegativeListener) {
...
//        mDialog.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE);
    ...
    /** start----------------------------------------- */
    public NotInputDialog setTitleText(String text) {
        mIsShowTitle = true;
        if (TextUtils.isEmpty(text)) {
            mTitle.setText("提示");
        } else {
    ...
    public NotInputDialog setTitleText(int textId) {
        mIsShowTitle = true;
        mTitle.setText(textId);
        return this;
    }

    public NotInputDialog setTitleTextColor(int colorId) {
        mIsShowTitle = true;
        mTitle.setTextColor(colorId);
        return this;
    }

    public NotInputDialog setTitleTextSize(int textSize) {
        mIsShowTitle = true;
    ...
    /** start----------------------------------------- */
    public NotInputDialog setContentMsgText(String text) {
        mIsShowContentInput = true;
        if (TextUtils.isEmpty(text)) {
    ...
    public NotInputDialog setContentMsgText(int textId) {
        mIsShowContentInput = true;
        mContentInput.setText(textId);
        return this;
    }

    public NotInputDialog setContentMsgTextColor(int colorId) {
        mIsShowContentInput = true;
        mContentInput.setTextColor(colorId);
        return this;
    }

    public NotInputDialog setContentMsgTextSize(int textSize) {
        mIsShowContentInput = true;
    ...
    /** start----------------------------------------- */
    public NotInputDialog setNegativeBtnText(String text) {
        mIsShowNegativeBtn = true;
        if (TextUtils.isEmpty(text)) {
            mNegativeBtn.setText("取消");
        } else {
    ...
    public NotInputDialog setNegativeBtnText(int textId) {
        mIsShowNegativeBtn = true;
        mNegativeBtn.setText(textId);
        return this;
    }

    public NotInputDialog setNegativeBtnTextColor(int colorId) {
        mIsShowNegativeBtn = true;
        mNegativeBtn.setTextColor(colorId);
        return this;
    }

    public NotInputDialog setNegativeBtnTextSize(int textSize) {
        mIsShowNegativeBtn = true;
        mNegativeBtn.setTextSize(textSize);
        return this;
    }

    public NotInputDialog setNegativeBtnListener(final OnNegativeListener onNegativeListener) {
        mIsShowPositiveBtn = true;
        mNegativeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    /** start----------------------------------------- */
    public NotInputDialog setPositiveBtnText(String text) {
        mIsShowPositiveBtn = true;
        if (TextUtils.isEmpty(text)) {
    ...
    public NotInputDialog setPositiveBtnText(int textId) {
        mIsShowPositiveBtn = true;
        mPositiveBtn.setText(textId);
        return this;
    }

    public NotInputDialog setPositiveBtnTextColor(int colorId) {
        mIsShowPositiveBtn = true;
        mPositiveBtn.setTextColor(colorId);
        return this;
    }

    public NotInputDialog setPositiveBtnTextSize(int textSize) {
        mIsShowPositiveBtn = true;
        mPositiveBtn.setTextSize(textSize);
        return this;
    }

    public NotInputDialog setPositiveBtnListener(final OnPositiveListener onPositiveListener) {
        mIsShowPositiveBtn = true;
        mPositiveBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
