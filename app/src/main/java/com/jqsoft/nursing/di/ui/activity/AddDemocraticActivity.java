...
import com.jqsoft.nursing.di.presenter.AddDemocraticPresenter;
...
//        }
    ...
    public Map<String, String> getRequestMapBase() {
        Map<String, String> map = ParametersFactory.saveDemocraticInfo(this, gfamliyId, gid, pingyiDate, pingyiResult, pingyiRenName, fileSize, pingyiMemo, dataArrayList);
        return map;
    }

    public Map<String, String> getRequestMapBasex() {
        Map<String, String> map = ParametersFactory.saveDemocraticInfo(this, gfamliyId, gid, pingyiDate, pingyiResult, pingyiRenName, fileSize, pingyiMemo, dataArrayListx);
        return map;
    }
        ...
        public void onSelectSuccess(List<LocalMedia> resultList) {
            ...
            for (int i = 0; i < resultList.size(); i++) {
                if (resultList.get(i).getType() == 1) {
                    ...
                    adapterImg.add(resultList.get(i));
