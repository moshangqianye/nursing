...
public class GuideActivityPresenter implements GuideActivityContract.presenter {
    ...
    private final GuideActivityContract.View view;
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getGuideList(ultimateMap)
                .compose(abstractActivity.<GCAHttpResultBaseBean<List<GuideBean>>>bindToLifecycle())
...
//                .subscribe(new Subscriber<HttpResultBaseBean<TreatmentListResultWrapperBean>>() {
                 .subscribe(new Subscriber<GCAHttpResultBaseBean<List<GuideBean>>>() {
                        @Override
                    public void onStart() {
                        super.onStart();
...
//                        }
                    ...
                    @Override
                    public void onNext(GCAHttpResultBaseBean<List<GuideBean>> bean) {
