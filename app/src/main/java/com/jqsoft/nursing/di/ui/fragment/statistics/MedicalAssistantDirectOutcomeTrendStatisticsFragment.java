...
/**
 * 折线图
 * 医疗救助-直接医疗救助站支出情况-趋势分析
 * Created by Administrator on 2018-01-02.
 */

public class MedicalAssistantDirectOutcomeTrendStatisticsFragment extends AbstractFragment implements MedicalAssistantDirectOutcomeStatisticsFragmentContract.View {
...
//    String supportType;
    ...
    public MedicalAssistantDirectOutcomeTrendStatisticsFragment() {
    }
    ...
    protected int getLayoutId() {
        return R.layout.fragment_medical_assistant_direct_outcome_trend_statistics_layout;
    }
