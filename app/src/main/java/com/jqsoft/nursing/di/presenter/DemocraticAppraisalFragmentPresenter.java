...
public class DemocraticAppraisalFragmentPresenter implements DemocraticAppraisalContract.presenter {

    private final DemocraticAppraisalContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public DemocraticAppraisalFragmentPresenter(DemocraticAppraisalContract.View view,
    ...
    public void getDemocraticpresent(Map<String, String> map) {
        ...
        GCAService.getdemocraticdata(map)
                .compose(abstractFragment.<GCAHttpResultBaseBean<List<DemocraticAppraisalBean>>>bindToLifecycle())
//                .delay(8000, TimeUnit.MILLISECONDS)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<GCAHttpResultBaseBean<List<DemocraticAppraisalBean>>>() {
                    @Override
                    public void onStart() {
                        super.onStart();
                    ...
                    @Override
                    public void onNext(GCAHttpResultBaseBean<List<DemocraticAppraisalBean>> bean) {
