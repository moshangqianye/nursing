...
public class AddServeryPresenter implements AddServeryActivityContract.presenter {

    private final AddServeryActivityContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService signedResidentClientService;


    @Inject
    public AddServeryPresenter(AddServeryActivityContract.View view,
...
//        ultimateMap.put(Constants.REQUEST_KEY, jsonString);
        ...
        signedResidentClientService.getaddSeverybasedata(map)
