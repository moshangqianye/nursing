...
/**
 * 折线图
 * 医疗救助-资助参保（参合）支出情况（一站式）-趋势
 * Created by Administrator on 2018-01-02.
 */

public class MedicalAssistantFinanceAssuranceTrendStatisticsFragment extends AbstractFragment implements MedicalAssistantFinanceAssuranceStatisticsFragmentContract.View {
...
//    String supportType;
    ...
    public MedicalAssistantFinanceAssuranceTrendStatisticsFragment() {
    }
    ...
    protected int getLayoutId() {
        return R.layout.fragment_medical_assistant_finance_assurance_trend_statistics_layout;
    }
