...
import com.jqsoft.nursing.adapter.SubsistenceArchiveAgeClassificationStatisticsAdapter;
...
import com.jqsoft.nursing.di.presenter.SubsistenceArchiveAgeClassificationStatisticsFragmentPresenter;
...
/**
 * 饼状图
 * 低保/特困人员供养/低收入家庭 年龄 分类统计
 * Created by Administrator on 2018-01-02.
 */

public class SubsistenceArchiveAgeClassificationStatisticsFragment extends AbstractFragment implements SubsistenceArchiveAgeClassificationStatisticsFragmentContract.View {
...
//    TextView tvPovertyReason;
    ...
    PieChart pcChart;
    @BindView(R.id.lay_subsistence_archive_age_classification_load_failure)
    View failureView;
    ...
    @Inject
    SubsistenceArchiveAgeClassificationStatisticsFragmentPresenter mPresenter;
...
//    String statisticsType;  //1	致贫原因    2	退保注销原因
    ...
    SubsistenceArchiveAgeClassificationStatisticsAdapter adapter;

    public SubsistenceArchiveAgeClassificationStatisticsFragment() {
    }
    ...
    protected int getLayoutId() {
        return R.layout.fragment_subsistence_archive_age_classification_statistics_layout;
    }
...
//        tvFailureView.setText(failureString);
        ...
        adapter = new SubsistenceArchiveAgeClassificationStatisticsAdapter(new ArrayList<NameValueBean>());
...
//        return Constants.EMPTY_STRING;
    ...
    protected void initInject() {
        DaggerApplication.get(getActivity())
                .getAppComponent()
                .addSubsistenceArchiveAgeClassificationStatisticsFragment(new SubsistenceArchiveAgeClassificationStatisticsFragmentModule(this))
                .inject(this);
    }
    ...
    private void loadInfo() {
        Map<String, String> map = getArchiveAgeClassificationListRequestMap();
        mPresenter.main(map);
    }

    private Map<String, String> getArchiveAgeClassificationListRequestMap() {
        Map<String, String> map = ParametersFactory.getSubsistenceArchiveAgeClassificationStatisticsListMap(getActivity(), subsistenceType,
