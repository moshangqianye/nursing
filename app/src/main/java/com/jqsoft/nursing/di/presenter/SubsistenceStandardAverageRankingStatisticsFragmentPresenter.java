...
public class SubsistenceStandardAverageRankingStatisticsFragmentPresenter implements SubsistenceStandardAverageRankingStatisticsFragmentContract.presenter {

    private final SubsistenceStandardAverageRankingStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public SubsistenceStandardAverageRankingStatisticsFragmentPresenter(SubsistenceStandardAverageRankingStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getSubsistenceStandardAverageRankingStatisticsList(ultimateMap)
