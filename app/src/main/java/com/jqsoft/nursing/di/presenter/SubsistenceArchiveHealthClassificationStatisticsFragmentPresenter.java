...
public class SubsistenceArchiveHealthClassificationStatisticsFragmentPresenter implements SubsistenceArchiveHealthClassificationStatisticsFragmentContract.presenter {

    private final SubsistenceArchiveHealthClassificationStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public SubsistenceArchiveHealthClassificationStatisticsFragmentPresenter(SubsistenceArchiveHealthClassificationStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getSubsistenceArchiveHealthClassificationStatisticsList(ultimateMap)
