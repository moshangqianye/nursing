...
public class SubsistenceArchiveRankingStatisticsFragmentPresenter implements SubsistenceArchiveRankingStatisticsFragmentContract.presenter {

    private final SubsistenceArchiveRankingStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public SubsistenceArchiveRankingStatisticsFragmentPresenter(SubsistenceArchiveRankingStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getSubsistenceArchiveRankingStatisticsList(ultimateMap)
