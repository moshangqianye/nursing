...
public class ExecutionProjectsActivityPresenter implements ExecutionProjectsActivityContract.presenter {

    private final ExecutionProjectsActivityContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public ExecutionProjectsActivityPresenter(ExecutionProjectsActivityContract.View view,
    ...
    public void main(Map<String, String> map, final boolean isLoadMore) {
        ...
        GCAService
                .getExecutionProjectsData(body)
                .compose(abstractActivity.<HttpResultBaseBean<List<ExecutionProjectsResultBean>>>bindToLifecycle())
...
//                .subscribe(new Subscriber<HttpResultBaseBean<TreatmentListResultWrapperBean>>() {
                .subscribe(new BaseSubscriber<HttpResultBaseBean<List<ExecutionProjectsResultBean>>>(context) {
                    @Override
                    public void onStart() {
                        super.onStart();
...
//                        }
                    ...
                    @Override
                    public void onNext(HttpResultBaseBean<List<ExecutionProjectsResultBean>> bean) {
