...
public class SubsistenceVarianceRankingStatisticsFragmentPresenter implements SubsistenceVarianceRankingStatisticsFragmentContract.presenter {

    private final SubsistenceVarianceRankingStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public SubsistenceVarianceRankingStatisticsFragmentPresenter(SubsistenceVarianceRankingStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getSubsistenceVarianceRankingStatisticsList(ultimateMap)
