...
import com.jqsoft.nursing.adapter.InstitutionServerClassificationStatisticsAdapter;
...
import com.jqsoft.nursing.di.presenter.InstitutionServerClassificationStatisticsFragmentPresenter;
...
public class InstitutionServerClassificationStatisticsFragment extends AbstractFragment implements InstitutionServerClassificationStatisticsFragmentContract.View {
...
//    TextView tvPovertyReason;
    ...
    PieChart pcChart;
    @BindView(R.id.lay_institution_server_classification_load_failure)
    View failureView;
    ...
    @Inject
    InstitutionServerClassificationStatisticsFragmentPresenter mPresenter;
...
//    int pageType;
    ...
    InstitutionServerClassificationStatisticsAdapter adapter;

    public InstitutionServerClassificationStatisticsFragment() {
    }
    ...
    protected int getLayoutId() {
        return R.layout.fragment_institution_server_classification_statistics_layout;
    }
...
//        initPersonType(personTypeIndex);
        RxView.clicks(tvPersonType)
                ...
                .subscribe(new Observer<Object>() {
                    ...
                    @Override
                    public void onNext(Object o) {
                        String[] typeArray = new String[]{"全部", "管理人员", "服务人员", "在编人员", "技术人员"};
                        List<String> typeList = Arrays.asList(typeArray);
                        Util.showSingleChoiceStringListMaterialDialog(getActivity(), "请选择人员类型", null, typeList,
...
//        tvFailureView.setText(failureString);
        ...
        adapter = new InstitutionServerClassificationStatisticsAdapter(new ArrayList<NameValuePercentBean>());
...
//        return Constants.EMPTY_STRING;
    ...
    protected void initInject() {
        DaggerApplication.get(getActivity())
                .getAppComponent()
                .addInstitutionServerClassificationStatisticsFragment(new InstitutionServerClassificationStatisticsFragmentModule(this))
                .inject(this);
    }
    ...
    private void loadInfo() {
        Map<String, String> map = getServerClassificationListRequestMap();
        mPresenter.main(map);
    }

    private Map<String, String> getServerClassificationListRequestMap() {
        Map<String, String> map = ParametersFactory.getInstitutionServerClassificationStatisticsListMap(getActivity(), institutionType,
                personType,
