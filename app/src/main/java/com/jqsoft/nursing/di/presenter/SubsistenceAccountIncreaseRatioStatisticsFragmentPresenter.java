...
public class SubsistenceAccountIncreaseRatioStatisticsFragmentPresenter implements SubsistenceAccountIncreaseRatioStatisticsFragmentContract.presenter {

    private final SubsistenceAccountIncreaseRatioStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public SubsistenceAccountIncreaseRatioStatisticsFragmentPresenter(SubsistenceAccountIncreaseRatioStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getSubsistenceAccountIncreaseRatioStatisticsList(ultimateMap)
