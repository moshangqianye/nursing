...
public class HistoryDetailPresenter implements HistoryDetailContract.presenter {
    ...
    private final HistoryDetailContract.View view;
    ...
    public void gethisdetail(Map<String, String> map, final boolean isLoadMore) {
        final Context context = (Context) view;
        AbstractActivity abstractActivity = (AbstractActivity) context;
        if (!Util.isNetworkConnected(context)) {
            view.onLoadHisdataFailure(Constants.HINT_LOADING_DATA_FAILURE, isLoadMore);
            return;
        }
...
//                        });
                    ...
                    public void onError(Throwable e) {
                        super.onError(e);
                        view.onLoadHisdataFailure(e.getMessage(), isLoadMore);
