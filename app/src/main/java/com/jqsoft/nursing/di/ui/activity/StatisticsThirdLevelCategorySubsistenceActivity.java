...
public class StatisticsThirdLevelCategorySubsistenceActivity extends AbstractActivity {
    //社会救助-城乡低保
    ...
    @BindView(R.id.ithl_cancel_reason)
    ImageTextHorizontalLayout ithlCancelReason;
    ...
    protected int getLayoutId() {
        return R.layout.activity_statistics_third_level_category_subsistence_layout;
    }
...
//        recyclerView.setAdapter(adapter);
    ...
    private void initItemClickListener(){
        ...
        ithlCancelReason.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
