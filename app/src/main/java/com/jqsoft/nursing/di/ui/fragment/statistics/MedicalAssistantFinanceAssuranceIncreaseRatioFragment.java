...
/**
 * 折线图
 * 医疗救助-资助参保（参合）支出情况（一站式）-资助参保增长率
 * Created by Administrator on 2018-01-02.
 */

public class MedicalAssistantFinanceAssuranceIncreaseRatioFragment extends AbstractFragment implements MedicalAssistantFinanceAssuranceStatisticsFragmentContract.View {
...
//    String supportType;
    ...
    public MedicalAssistantFinanceAssuranceIncreaseRatioFragment() {
    }
...
//        } else {
            if (Constants.MEDICAL_ASSISTANT_FINANCE_ASSURANCE_INCREASE_RATIO_VALUE.equals(type)) {
                set1 = new LineDataSet(yVals1, "资助金额同比增长率(%)");
//                set1 = new LineDataSet(yVals1, "资助参保金额同比增长率(%)");
                ...
                set2 = new LineDataSet(yVals2, "资助人数同比增长率(%)");
//                set2 = new LineDataSet(yVals2, "资助参保人数同比增长率(%)");
                ...
                set3 = new LineDataSet(yVals3, "资助金额环比增长率(%)");
//                set3 = new LineDataSet(yVals3, "资助参保金额环比增长率(%)");
                ...
                set4 = new LineDataSet(yVals4, "资助人数环比增长率(%)");
//                set4 = new LineDataSet(yVals4, "资助参保人数环比增长率(%)");
                ...
                set1 = new LineDataSet(yVals1, "资助人数");
                set1.setColor(Constants.CHART_FIRST_COLOR);
                set1.setValueTextColor(Constants.CHART_FIRST_COLOR);
                set1.setLineWidth(Constants.LINE_CHART_LINE_WIDTH);
                set1.setCircleRadius(Constants.LINE_CHART_CIRCLE_RADIUS);
                set1.setHighLightColor(Constants.LINE_CHART_HILIGHT_COLOR);
                set1.setDrawValues(true);
                set2 = new LineDataSet(yVals2, "资助金额(元)");
                set2.setColor(Constants.CHART_SECOND_COLOR);
                set2.setValueTextColor(Constants.CHART_SECOND_COLOR);
                set2.setLineWidth(Constants.LINE_CHART_LINE_WIDTH);
                set2.setCircleRadius(Constants.LINE_CHART_CIRCLE_RADIUS);
