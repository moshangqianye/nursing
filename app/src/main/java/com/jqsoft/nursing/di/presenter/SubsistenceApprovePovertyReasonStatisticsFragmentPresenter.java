...
public class SubsistenceApprovePovertyReasonStatisticsFragmentPresenter implements SubsistenceApprovePovertyReasonStatisticsFragmentContract.presenter {

    private final SubsistenceApprovePovertyReasonStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public SubsistenceApprovePovertyReasonStatisticsFragmentPresenter(SubsistenceApprovePovertyReasonStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getSubsistenceApprovePovertyReasonStatisticsList(ultimateMap)
                .compose(abstractActivity.<GCAHttpResultBaseBean<List<SubsistenceApprovePovertyReasonBean>>>bindToLifecycle())
//                .compose(abstractActivity.bindUntilEvent(ActivityEvent.DESTROY))
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<GCAHttpResultBaseBean<List<SubsistenceApprovePovertyReasonBean>>>() {
                    @Override
                    public void onStart() {
                        super.onStart();
                    ...
                    @Override
                    public void onNext(GCAHttpResultBaseBean<List<SubsistenceApprovePovertyReasonBean>> bean) {
//                        Util.decodeBase64Bean(bean);
                        ...
                        if (isEmpty){
                            isSuccessful=true;
                            if (bean!=null){
                                bean.setData(new ArrayList<SubsistenceApprovePovertyReasonBean>());
                            }
                        }
                        if (isSuccessful) {
