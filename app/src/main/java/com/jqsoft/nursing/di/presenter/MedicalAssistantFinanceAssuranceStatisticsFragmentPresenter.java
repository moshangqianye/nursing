...
public class MedicalAssistantFinanceAssuranceStatisticsFragmentPresenter implements MedicalAssistantFinanceAssuranceStatisticsFragmentContract.presenter {

    private final MedicalAssistantFinanceAssuranceStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public MedicalAssistantFinanceAssuranceStatisticsFragmentPresenter(MedicalAssistantFinanceAssuranceStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getMedicalAssistantFinanceAssuranceStatisticsList(ultimateMap)
