...
public class FamilyEconomyCheckTrendStatisticsFragmentPresenter implements FamilyEconomyCheckTrendStatisticsFragmentContract.presenter {

    private final FamilyEconomyCheckTrendStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public FamilyEconomyCheckTrendStatisticsFragmentPresenter(FamilyEconomyCheckTrendStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getFamilyEconomyCheckTrendStatisticsList(ultimateMap)
