...
//        recyclerView.setAdapter(adapter);
    ...
    private void initItemClickListener(){
        ithlMoneyConstitution.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(0));
            }
        });
        ithlCompensateMethod.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(1));
            }
        });
        ithlCompensateCategory.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(2));
            }
        });
        ithlAssistanceOutcomeRanking.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(3));
            }
        });
        ithlAssistanceOutcomeTrend.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(4));
            }
        });
        ithlAssistanceOutcomeCategory.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(5));
            }
        });
        ithlAssistanceIncreaseRatio.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(6));
            }
        });
        ithlAssistanceOutcomeLevel.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(7));
            }
        });
        ithlFinanceRanking.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(8));
            }
        });
        ithlFinanceTrend.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(9));
            }
        });
        ithlFinanceIncreaseRatio.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
