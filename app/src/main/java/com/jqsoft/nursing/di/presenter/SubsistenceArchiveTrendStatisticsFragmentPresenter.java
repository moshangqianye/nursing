...
public class SubsistenceArchiveTrendStatisticsFragmentPresenter implements SubsistenceArchiveTrendStatisticsFragmentContract.presenter {

    private final SubsistenceArchiveTrendStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public SubsistenceArchiveTrendStatisticsFragmentPresenter(SubsistenceArchiveTrendStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getSubsistenceArchiveTrendStatisticsList(ultimateMap)
