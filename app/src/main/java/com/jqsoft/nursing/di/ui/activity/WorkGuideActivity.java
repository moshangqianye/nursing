...
public class WorkGuideActivity extends AbstractActivity implements
...
//
//    @Override
//    public void onLoadMoreListSuccess(GCAHttpResultBaseBean<List<ReceptionBean>> beanList) {
...
//        }
        ...
        allcityList = LitePal.where(" areaLevel=?  ","area_1").find(SRCLoginAreaBean.class);
        allcityList2 = LitePal.where(" areaLevel=? ","area_2" ).find(SRCLoginAreaBean.class);
        allcityList3 = LitePal.where(" areaLevel=? ","area_3" ).find(SRCLoginAreaBean.class);
...
//                Toast.makeText(getApplicationContext(),"点击了"+rightStr[section][position], Toast.LENGTH_SHORT).show();
                ...
                Util.gotoActivityWithBundle(WorkGuideActivity.this, ReceptionListActivity.class, bundle);
