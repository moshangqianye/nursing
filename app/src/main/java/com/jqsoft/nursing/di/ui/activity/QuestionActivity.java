...
public class QuestionActivity extends AbstractActivity implements
        QuestionActivityContract.View, SwipeRefreshLayout.OnRefreshListener
     {
...
//
//                Util.gotoActivityWithBundle(QuestionActivity.this, ReceptionDetailActivity.class, bundle);
            }
        });
