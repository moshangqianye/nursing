...
public class IndexElderFragmentPresenter implements IndexElderFragmentContract.presenter {

    private final IndexElderFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public IndexElderFragmentPresenter(IndexElderFragmentContract.View view,
...
//        ultimateMap.put(Constants.REQUEST_KEY, jsonString);
        GCAService.getIndexElderList(map)
                .compose(abstractFragment.<HttpResultNurseBaseBean<IndexElderBean>>bindToLifecycle())
//                .delay(8000, TimeUnit.MILLISECONDS)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<HttpResultNurseBaseBean<IndexElderBean>>() {
                    @Override
                    public void onStart() {
                        super.onStart();
                    ...
                    @Override
                    public void onNext(HttpResultNurseBaseBean<IndexElderBean> bean) {
