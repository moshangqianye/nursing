...
public class InstitutionRankingStatisticsFragmentPresenter implements InstitutionRankingStatisticsFragmentContract.presenter {

    private final InstitutionRankingStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public InstitutionRankingStatisticsFragmentPresenter(InstitutionRankingStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getInstitutionRankingStatisticsList(ultimateMap)
