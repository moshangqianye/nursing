...
public class StatisticsThirdLevelCategoryVeryPoorActivity extends AbstractActivity {
    //社会救助-城乡低保
    ...
    TextView tvTitle;
    @BindView(R.id.ithl_variance_ranking)
    ImageTextHorizontalLayout ithlVarianceRanking;
    @BindView(R.id.ithl_variance_trend)
    ImageTextHorizontalLayout ithlVarianceTrend;
    @BindView(R.id.ithl_approve_ranking)
    ImageTextHorizontalLayout ithlApproveRanking;
    @BindView(R.id.ithl_approve_trend)
    ImageTextHorizontalLayout ithlApproveTrend;
    @BindView(R.id.ithl_poverty_reason)
    ImageTextHorizontalLayout ithlPovertyReason;
    @BindView(R.id.ithl_archive_ranking)
    ImageTextHorizontalLayout ithlArchiveRanking;
    @BindView(R.id.ithl_archive_trend)
    ImageTextHorizontalLayout ithlArchiveTrend;
    @BindView(R.id.ithl_archive_health_classification)
    ImageTextHorizontalLayout ithlArchiveHealthClassification;
    @BindView(R.id.ithl_archive_ability_classification)
    ImageTextHorizontalLayout ithlArchiveAbilityClassification;
    @BindView(R.id.ithl_archive_age_classification)
    ImageTextHorizontalLayout ithlArchiveAgeClassification;
    @BindView(R.id.ithl_account_ranking)
    ImageTextHorizontalLayout ithlAccountRanking;
    @BindView(R.id.ithl_account_trend)
    ImageTextHorizontalLayout ithlAccountTrend;
    @BindView(R.id.ithl_account_increase_ratio)
    ImageTextHorizontalLayout ithlAccountIncreaseRatio;
    @BindView(R.id.ithl_standard_ranking)
    ImageTextHorizontalLayout ithlStandardRanking;
    @BindView(R.id.ithl_standard_average_ranking)
    ImageTextHorizontalLayout ithlStandardAverageRanking;
    @BindView(R.id.ithl_institution_ranking)
    ImageTextHorizontalLayout ithlInstitutionRanking;
    @BindView(R.id.ithl_institution_character_classification)
    ImageTextHorizontalLayout ithlInstitutionCharacterClassification;
    @BindView(R.id.ithl_institution_server_classification)
    ImageTextHorizontalLayout ithlInstitutionServerClassification;
    @BindView(R.id.ithl_institution_legal_person_classification)
    ImageTextHorizontalLayout ithlInstitutionLegalPersonClassification;
    ...
    protected int getLayoutId() {
        return R.layout.activity_statistics_third_level_category_very_poor_layout;
    }
...
//        recyclerView.setAdapter(adapter);
    ...
    private void initItemClickListener(){
        ithlVarianceRanking.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(0));
            }
        });
        ithlVarianceTrend.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(1));
            }
        });
        ithlApproveRanking.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(2));
            }
        });
        ithlApproveTrend.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(3));
            }
        });
        ithlPovertyReason.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(4));
            }
        });
        ithlArchiveRanking.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(5));
            }
        });
        ithlArchiveTrend.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(6));
            }
        });
        ithlArchiveHealthClassification.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(7));
            }
        });
        ithlArchiveAbilityClassification.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(8));
            }
        });
        ithlArchiveAgeClassification.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(9));
            }
        });
        ithlAccountRanking.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(10));
            }
        });
        ithlAccountTrend.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(11));
            }
        });
        ithlAccountIncreaseRatio.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(12));
            }
        });
        ithlStandardRanking.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(13));
            }
        });
        ithlStandardAverageRanking.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(14));
            }
        });
        ithlInstitutionRanking.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(15));
            }
        });
        ithlInstitutionCharacterClassification.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(16));
            }
        });
        ithlInstitutionServerClassification.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(17));
            }
        });
        ithlInstitutionLegalPersonClassification.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(18));
            }
        });
    }
