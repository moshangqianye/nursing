...
public class PersonCollectionActivityPresenter implements PersonCollectionActivityContract.presenter {

    private final PersonCollectionActivityContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public PersonCollectionActivityPresenter(PersonCollectionActivityContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getPersonCollection(ultimateMap)
                .compose(abstractActivity.<GCAHttpResultBaseBean<List<PersonCollectionBean>>>bindToLifecycle())
...
//                .subscribe(new Subscriber<HttpResultBaseBean<TreatmentListResultWrapperBean>>() {
                 .subscribe(new Subscriber<GCAHttpResultBaseBean<List<PersonCollectionBean>>>() {
                        @Override
                    public void onStart() {
                        super.onStart();
...
//                        }
                    ...
                    @Override
                    public void onNext(GCAHttpResultBaseBean<List<PersonCollectionBean>> bean) {
