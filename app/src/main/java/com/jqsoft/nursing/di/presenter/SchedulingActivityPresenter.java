...
public class SchedulingActivityPresenter implements SchedulingFragmentContract.presenter {

    private final SchedulingActivityContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public SchedulingActivityPresenter(SchedulingActivityContract.View view,
...
//        ultimateMap.put(Constants.REQUEST_KEY, jsonString);
        GCAService.getSchedulingList(map)
                .compose(abstractActivity.<HttpResultNurseBaseBean<List<SchedulingBean>>>bindToLifecycle())
