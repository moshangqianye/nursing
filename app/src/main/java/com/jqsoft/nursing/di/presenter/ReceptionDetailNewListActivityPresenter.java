...
public class ReceptionDetailNewListActivityPresenter implements ReceptionDetailNewListActivityContract.presenter {

    private final ReceptionDetailNewListActivityContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public ReceptionDetailNewListActivityPresenter(ReceptionDetailNewListActivityContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getReceptionDetailNewList(ultimateMap)
                .compose(abstractActivity.<GCAHttpResultBaseBean<ReceptionDetailNewListBean>>bindToLifecycle())
...
//                .subscribe(new Subscriber<HttpResultBaseBean<TreatmentListResultWrapperBean>>() {
                 .subscribe(new Subscriber<GCAHttpResultBaseBean<ReceptionDetailNewListBean>>() {
                        @Override
                    public void onStart() {
                        super.onStart();
...
//                        }
                    ...
                    @Override
                    public void onNext(GCAHttpResultBaseBean<ReceptionDetailNewListBean> bean) {
