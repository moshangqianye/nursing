...
import com.jqsoft.nursing.di.contract.SaveExecuServeritemContract;
...
public class SaveExecuServerItenmPresenter implements SaveExecuServeritemContract.presenter {

    private final SaveExecuServeritemContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public SaveExecuServerItenmPresenter(SaveExecuServeritemContract.View view,
