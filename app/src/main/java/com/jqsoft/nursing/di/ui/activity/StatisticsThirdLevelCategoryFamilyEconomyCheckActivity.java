...
public class StatisticsThirdLevelCategoryFamilyEconomyCheckActivity extends AbstractActivity {
    //社会救助-城乡低保
...
//            ,STATISTICS_LOW_SALARY_FAMILY_THIRD_LEVEL_MODULE_ID_ARCHIVE_AGE_CLASSIFY
    ...
    TextView tvTitle;
    @BindView(R.id.ithl_acceptance_ranking)
    ImageTextHorizontalLayout ithlAcceptanceRanking;
    @BindView(R.id.ithl_acceptance_trend)
    ImageTextHorizontalLayout ithlAcceptanceTrend;
    @BindView(R.id.ithl_check_project_category)
    ImageTextHorizontalLayout ithlCheckProjectCategory;
    @BindView(R.id.ithl_share_index)
    ImageTextHorizontalLayout ithlShareIndex;
    @BindView(R.id.ithl_report_ranking)
    ImageTextHorizontalLayout ithlReportRanking;
    @BindView(R.id.ithl_report_trend)
    ImageTextHorizontalLayout ithlReportTrend;
    @BindView(R.id.ithl_review_ranking)
    ImageTextHorizontalLayout ithlReviewRanking;
    @BindView(R.id.ithl_review_trend)
    ImageTextHorizontalLayout ithlReviewTrend;
    ...
    protected int getLayoutId() {
        return R.layout.activity_statistics_third_level_category_family_economy_check_layout;
    }
...
//        recyclerView.setAdapter(adapter);
    ...
    private void initItemClickListener(){
        ithlAcceptanceRanking.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(0));
            }
        });
        ithlAcceptanceTrend.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(1));
            }
        });
        ithlCheckProjectCategory.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(2));
            }
        });
        ithlShareIndex.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(3));
            }
        });
        ithlReportRanking.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(4));
            }
        });
        ithlReportTrend.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(5));
            }
        });
        ithlReviewRanking.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
                gotoModule(list.get(6));
            }
        });
        ithlReviewTrend.setClickListener(new ImageTextHorizontalLayout.ClickListener() {
            @Override
            public void layoutDidClick() {
