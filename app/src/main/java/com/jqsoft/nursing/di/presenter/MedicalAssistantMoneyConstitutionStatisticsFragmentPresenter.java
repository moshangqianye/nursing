...
public class MedicalAssistantMoneyConstitutionStatisticsFragmentPresenter implements MedicalAssistantMoneyConstitutionStatisticsFragmentContract.presenter {

    private final MedicalAssistantMoneyConstitutionStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public MedicalAssistantMoneyConstitutionStatisticsFragmentPresenter(MedicalAssistantMoneyConstitutionStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getMedicalAssistantMoneyConstitutionStatisticsList(ultimateMap)
                .compose(abstractActivity.<GCAHttpResultBaseBean<List<MedicalAssistantMoneyConstitutionBean>>>bindToLifecycle())
//                .compose(abstractActivity.bindUntilEvent(ActivityEvent.DESTROY))
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<GCAHttpResultBaseBean<List<MedicalAssistantMoneyConstitutionBean>>>() {
                    @Override
                    public void onStart() {
                        super.onStart();
                    ...
                    @Override
                    public void onNext(GCAHttpResultBaseBean<List<MedicalAssistantMoneyConstitutionBean>> bean) {
//                        Util.decodeBase64Bean(bean);
                        ...
                        if (isEmpty){
                            isSuccessful=true;
                            if (bean!=null){
                                bean.setData(new ArrayList<MedicalAssistantMoneyConstitutionBean>());
                            }
                        }
                        if (isSuccessful) {
