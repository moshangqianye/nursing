...
public class DisPlayDemoCraticPresenter implements DisPlayDemoCraticContract.presenter {

    private final DisPlayDemoCraticContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService signedResidentClientService;


    @Inject
    public DisPlayDemoCraticPresenter(DisPlayDemoCraticContract.View view,
...
//        ultimateMap.put(Constants.REQUEST_KEY, jsonString);
        ...
        signedResidentClientService.getDemocraticBase(map)
