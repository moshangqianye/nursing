...
public class FamilyEconomyCheckShareIndexStatisticsFragmentPresenter implements FamilyEconomyCheckShareIndexStatisticsFragmentContract.presenter {

    private final FamilyEconomyCheckShareIndexStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public FamilyEconomyCheckShareIndexStatisticsFragmentPresenter(FamilyEconomyCheckShareIndexStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getFamilyEconomyCheckShareIndexStatisticsList(ultimateMap)
