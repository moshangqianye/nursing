...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getPersonalInfo(ultimateMap)
                .compose(abstractActivity.<GCAHttpResultBaseBean<PersonalInfoBean>>bindToLifecycle())
...
//                .subscribe(new Subscriber<HttpResultBaseBean<TreatmentListResultWrapperBean>>() {
                .subscribe(new Subscriber<GCAHttpResultBaseBean<PersonalInfoBean>>() {
                    @Override
                    public void onStart() {
                        super.onStart();
...
//                        }
                    ...
                    @Override
                    public void onNext(GCAHttpResultBaseBean<PersonalInfoBean> bean) {
...
//                        });
                    ...
                    public void onError(Throwable e) {
                        Util.hideGifProgressDialog(context);
                        view.onPostFailure(e.getMessage());
//                        Activity activity = (Activity) view;
//                        Util.hideGifProgressDialog(activity);
