    ...
    protected void initData() {
        ...
        tv_sex.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(sex.equals("")){
                    Toast.makeText(UrbanFamilybianjiActivity.this,"请输入正确的身份证号码,会自动填充性别!",Toast.LENGTH_SHORT).show();
                }
        ...
        tv_birth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(sex.equals("")){
                    Toast.makeText(UrbanFamilybianjiActivity.this,"请输入正确的身份证号码,会自动填充出生年月!",Toast.LENGTH_SHORT).show();
                }
            ...
            public void onClick(View v) {
              ...
              /*  String sexName = IDCard.getSex(sidcard);
                ...
                if(TextUtils.isEmpty(sname)){
                    Toast.makeText(UrbanFamilybianjiActivity.this,"姓名不能为空",Toast.LENGTH_SHORT).show();
                }else if(TextUtils.isEmpty(sidcard)){
                    Toast.makeText(UrbanFamilybianjiActivity.this,"身份证号码不能为空",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(UrbanFamilybianjiActivity.this,"其他家庭成员已存在该身份证号码",Toast.LENGTH_SHORT).show();
                } else if(TextUtils.isEmpty(ssex)){
                    Toast.makeText(UrbanFamilybianjiActivity.this,"性别不能为空",Toast.LENGTH_SHORT).show();
                }else if(TextUtils.isEmpty(sbirth)){
                    Toast.makeText(UrbanFamilybianjiActivity.this,"出生日期不能为空",Toast.LENGTH_SHORT).show();
                }else if(TextUtils.isEmpty(sguanxi)){
                    Toast.makeText(UrbanFamilybianjiActivity.this,"与户主关系不能为空",Toast.LENGTH_SHORT).show();
                }else if(TextUtils.isEmpty(snation)){
                    Toast.makeText(UrbanFamilybianjiActivity.this,"民族不能为空",Toast.LENGTH_SHORT).show();
                }else if(TextUtils.isEmpty(sjiuyeqingkuang)){
                    Toast.makeText(UrbanFamilybianjiActivity.this,"就业情况不能为空",Toast.LENGTH_SHORT).show();
                }else if(TextUtils.isEmpty(scanbaoleixing)){
                    Toast.makeText(UrbanFamilybianjiActivity.this,"参保类型不能为空",Toast.LENGTH_SHORT).show();
                }else if(TextUtils.isEmpty(slaodongnengli)){
                    Toast.makeText(UrbanFamilybianjiActivity.this,"劳动能力不能为空",Toast.LENGTH_SHORT).show();
                }else if(TextUtils.isEmpty(shunyinzhuangkuang)){
                    Toast.makeText(UrbanFamilybianjiActivity.this,"婚姻状况不能为空",Toast.LENGTH_SHORT).show();
                }else {
                        ...
                        public void Succ(String res) {
                            ...
                            if(result != null){
                                if(result.getErrorcode() == 0){
                                    ...
                                    Util.hideGifProgressDialog(UrbanFamilybianjiActivity.this);
                                    Toast.makeText(UrbanFamilybianjiActivity.this,"识别失败，请拍照清楚后重新识别", Toast.LENGTH_SHORT).show();
