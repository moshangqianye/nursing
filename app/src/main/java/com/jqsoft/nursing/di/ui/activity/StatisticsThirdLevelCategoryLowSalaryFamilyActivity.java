...
public class StatisticsThirdLevelCategoryLowSalaryFamilyActivity extends AbstractActivity {
    //社会救助-城乡低保
    ...
    protected int getLayoutId() {
        return R.layout.activity_statistics_third_level_category_low_salary_family_layout;
    }
