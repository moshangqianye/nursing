...
public class InstitutionServerClassificationStatisticsFragmentPresenter implements InstitutionServerClassificationStatisticsFragmentContract.presenter {

    private final InstitutionServerClassificationStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public InstitutionServerClassificationStatisticsFragmentPresenter(InstitutionServerClassificationStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getInstitutionServerClassificationStatisticsList(ultimateMap)
