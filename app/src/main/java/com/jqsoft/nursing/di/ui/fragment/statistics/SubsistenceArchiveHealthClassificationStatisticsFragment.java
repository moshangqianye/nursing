...
import com.jqsoft.nursing.adapter.SubsistenceArchiveHealthClassificationStatisticsAdapter;
...
import com.jqsoft.nursing.di.presenter.SubsistenceArchiveHealthClassificationStatisticsFragmentPresenter;
...
/**
 * 饼状图
 * 低保/特困人员供养/低收入家庭 健康情况 分类统计
 * Created by Administrator on 2018-01-02.
 */

public class SubsistenceArchiveHealthClassificationStatisticsFragment extends AbstractFragment implements SubsistenceArchiveHealthClassificationStatisticsFragmentContract.View {
...
//    TextView tvPovertyReason;
    ...
    PieChart pcChart;
    @BindView(R.id.lay_subsistence_archive_health_classification_load_failure)
    View failureView;
    ...
    @Inject
    SubsistenceArchiveHealthClassificationStatisticsFragmentPresenter mPresenter;
...
//    String statisticsType;  //1	致贫原因    2	退保注销原因
    ...
    SubsistenceArchiveHealthClassificationStatisticsAdapter adapter;

    public SubsistenceArchiveHealthClassificationStatisticsFragment() {
    }
    ...
    protected int getLayoutId() {
        return R.layout.fragment_subsistence_archive_health_classification_statistics_layout;
    }
...
//        tvFailureView.setText(failureString);
        ...
        adapter = new SubsistenceArchiveHealthClassificationStatisticsAdapter(new ArrayList<NameValueBean>());
...
//        return Constants.EMPTY_STRING;
    ...
    protected void initInject() {
        DaggerApplication.get(getActivity())
                .getAppComponent()
                .addSubsistenceArchiveHealthClassificationStatisticsFragment(new SubsistenceArchiveHealthClassificationStatisticsFragmentModule(this))
                .inject(this);
    }
    ...
    private void loadInfo() {
        Map<String, String> map = getArchiveHealthClassificationListRequestMap();
        mPresenter.main(map);
    }

    private Map<String, String> getArchiveHealthClassificationListRequestMap() {
        Map<String, String> map = ParametersFactory.getSubsistenceArchiveHealthClassificationStatisticsListMap(getActivity(), subsistenceType,
                getMonth(), supportType, getAreaCodeString(), methodName);
        return map;
    }
