...
public class FamilyEconomyCheckRankingStatisticsFragmentPresenter implements FamilyEconomyCheckRankingStatisticsFragmentContract.presenter {

    private final FamilyEconomyCheckRankingStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public FamilyEconomyCheckRankingStatisticsFragmentPresenter(FamilyEconomyCheckRankingStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getFamilyEconomyCheckRankingStatisticsList(ultimateMap)
