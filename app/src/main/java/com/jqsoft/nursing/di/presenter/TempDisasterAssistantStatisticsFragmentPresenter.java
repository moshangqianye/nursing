...
public class TempDisasterAssistantStatisticsFragmentPresenter implements TempDisasterAssistantStatisticsFragmentContract.presenter {

    private final TempDisasterAssistantStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public TempDisasterAssistantStatisticsFragmentPresenter(TempDisasterAssistantStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getTempDisasterAssistantStatisticsList(ultimateMap)
