...
public class NotificationActivityPresenter implements NotificationActivityContract.presenter {

    private final NotificationActivityContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public NotificationActivityPresenter(NotificationActivityContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getNotificationList(ultimateMap)
                .compose(abstractActivity.<GCAHttpResultBaseBean<List<NotificationBean>>>bindToLifecycle())
