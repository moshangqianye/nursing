...
public class UseCollectionFragmentPresenter implements UseCollectionFragmentContract.presenter {

    private final UseCollectionFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public UseCollectionFragmentPresenter(UseCollectionFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                ...
                .compose(abstractFragment.<GCAHttpResultBaseBean<List<PersonCollectionBean>>>bindToLifecycle())
