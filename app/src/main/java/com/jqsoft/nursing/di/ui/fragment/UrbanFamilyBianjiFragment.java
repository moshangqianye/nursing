...
//政策解读列表
public class UrbanFamilyBianjiFragment extends AbstractFragment implements
                ...
                //    bundle.putString("batchNo", "20180201092502878");
                  ...
                  //  startActivity(i);
                    ...
                    if(status.equals("0")){
                        ...
                        bundle.putString("batchNo", mybatchno);
                        bundle.putString("relation", relation);
                        Intent i = new Intent(getActivity(), UrbanFamilybianjiStatusActivity.class);
                        i.putExtras(bundle);
                        i.putExtra("mCardList",(Serializable) mCardList);
                        //  startActivity(i);
                        startActivityForResult(i, REQUEST_A);
...
//        tvFailureView.setText(failureString);
        ...
        final BaseQuickAdapter<UrbanLowFamilyBean, BaseViewHolder> mAdapter = new UrbanLowFamilyAdapter(new ArrayList<UrbanLowFamilyBean>(), TYPE_MULTIPLE_LINE,getActivity(),status);
...
//    }
    ...
    protected void initInject() {
       DaggerApplication.get(getActivity())
                .getAppComponent()
                .addUrbanLowFamilybianjiFragment(new UrbanLowFamilyFragmentModule(this))
                .inject(this);
    }
