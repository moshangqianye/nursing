...
//            return;
//        }
//        mIsGps = intent.getBooleanExtra(Constants.GPS_KEY, false);
//        NaviLatLng start = intent.getParcelableExtra(Constants.START_KEY);
//        NaviLatLng end = intent.getParcelableExtra(Constants.END_KEY);
