...
public class SubsistenceAccountTrendStatisticsFragmentPresenter implements SubsistenceAccountTrendStatisticsFragmentContract.presenter {

    private final SubsistenceAccountTrendStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public SubsistenceAccountTrendStatisticsFragmentPresenter(SubsistenceAccountTrendStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getSubsistenceAccountTrendStatisticsList(ultimateMap)
