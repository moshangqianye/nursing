...
public class SubsistenceArchiveAgeClassificationStatisticsFragmentPresenter implements SubsistenceArchiveAgeClassificationStatisticsFragmentContract.presenter {

    private final SubsistenceArchiveAgeClassificationStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public SubsistenceArchiveAgeClassificationStatisticsFragmentPresenter(SubsistenceArchiveAgeClassificationStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getSubsistenceArchiveAgeClassificationStatisticsList(ultimateMap)
