...
public class SubsistenceStandardRankingStatisticsFragmentPresenter implements SubsistenceStandardRankingStatisticsFragmentContract.presenter {

    private final SubsistenceStandardRankingStatisticsFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public SubsistenceStandardRankingStatisticsFragmentPresenter(SubsistenceStandardRankingStatisticsFragmentContract.View view,
...
//        RequestBody body = Util.getBodyFromMap(map);
        ...
        GCAService
                .getSubsistenceStandardRankingStatisticsList(ultimateMap)
