...
import com.jqsoft.nursing.adapter.SubsistenceStandardAverageRankingStatisticsAdapter;
...
import com.jqsoft.nursing.di.presenter.SubsistenceStandardAverageRankingStatisticsFragmentPresenter;
...
public class SubsistenceStandardAverageRankingStatisticsFragment extends AbstractFragment implements SubsistenceStandardAverageRankingStatisticsFragmentContract.View {
...
//        } else {
            // create 4 DataSets
            set1 = new BarDataSet(yVals1, "人均补助(元/月/人)");
            set1.setColor(Constants.CHART_FIRST_COLOR);
//            set2 = new BarDataSet(yVals2, "复查");
//            set2.setColor(Constants.CHART_SECOND_COLOR);
//            set3 = new BarDataSet(yVals3, "注销");
