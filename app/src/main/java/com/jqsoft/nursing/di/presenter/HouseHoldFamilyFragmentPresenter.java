...
public class HouseHoldFamilyFragmentPresenter implements HouseHoldFaimilyMemberContract.presenter {

    private final HouseHoldFaimilyMemberContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public HouseHoldFamilyFragmentPresenter(HouseHoldFaimilyMemberContract.View view,
    ...
    public void getfamilypresent(Map<String, String> map) {
        ...
        GCAService.gethouseFamilydata(map)
                .compose(abstractFragment.<GCAHttpResultBaseBean<List<FamilyMemberListBean>>>bindToLifecycle())
//                .delay(8000, TimeUnit.MILLISECONDS)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<GCAHttpResultBaseBean<List<FamilyMemberListBean>>>() {
                    @Override
                    public void onStart() {
                        super.onStart();
                    ...
                    @Override
                    public void onNext(GCAHttpResultBaseBean<List<FamilyMemberListBean>> bean) {
