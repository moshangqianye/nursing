...
//    public static String PREFERENCE_NAME = "TrineaAndroidCommon";
    public static String PREFERENCE_NAME = "SignedDoctorClient";
    ...
    public static LoginResultNewBean getUserLoginInfo(Context context){
        LoginResultNewBean info = new LoginResultNewBean();
        try {
            if(context==null){
                info.setCity("");
                info.setCityName("");
                info.setCommunity("");
                info.setCommunityName("");
                info.setCounty("");
                info.setCountyName("");
                info.setLoginName("");
                info.setPassword("");
                info.setProvince("");
                info.setProvinceName("");
                info.setRealName("");
                info.setStreet("");
                info.setStreetName("");
                info.setGKey("");
                info.setSAddUserId("");
                info.setSAddUserName("");
                info.setSOrgCode("");
                info.setSOrgName("");
                ...
                Gson gson = new Gson();
                String json2= PreferencesUtils.getString(context,"UserLoginInfo");
                if(TextUtils.isEmpty(json2)){
                    ...
                    info=gson.fromJson(json2, LoginResultNewBean.class);
                }
