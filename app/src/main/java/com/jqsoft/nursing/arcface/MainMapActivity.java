...
import com.jqsoft.nursing.adapter.AddressAdapter;
import com.jqsoft.nursing.base.Constants;
import com.jqsoft.nursing.bean.grassroots_civil_administration.PersonLocationBean;
import com.jqsoft.nursing.util.DataConversionUtils;
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.ll_back:
                        ...
                        break;
//                    case R.id.iv_search:
////                        Toast.makeText(MainMapActivity.this, "搜索", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(MainMapActivity.this, "定位", Toast.LENGTH_SHORT).show();
                    ...
                    case R.id.bt_send:
                        if (null != mList && 0 < mList.size() && null != mAddressAdapter) {
                            ...
                            String slongitude=poiItem.getLatLonPoint()+"";
                            ...
                            intent.putExtra("selectedMapLocationKey", plb);

                            MainMapActivity.this.setResult(10,intent);
                            MainMapActivity.this.finish();


                            //     Toast.makeText(MainMapActivity.this, "发送：" + poiItem.getTitle() + "  " + poiItem.getSnippet() + "  " + "纬度：" + poiItem.getLatLonPoint().getLatitude() + "  " + "经度：" + poiItem.getLatLonPoint().getLongitude(), Toast.LENGTH_SHORT).show();
                        }
                        break;
                }
            }
