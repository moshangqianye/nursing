 ...
 */
public class MaterialSearchViewNew extends FrameLayout implements Filter.FilterListener {
    ...
    public MaterialSearchViewNew(Context context) {
        this(context, null);
    }

    public MaterialSearchViewNew(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MaterialSearchViewNew(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
    ...
    private void initSearchView() {
        ...
        mSearchSrcTextView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mUserQuery = s;
                startFilter(s);
                MaterialSearchViewNew.this.onTextChanged(s);
            }
    ...
    private void startFilter(CharSequence s) {
        if (mAdapter != null && mAdapter instanceof Filterable) {
            ((Filterable) mAdapter).getFilter().filter(s, MaterialSearchViewNew.this);
        }
    }
...
//        }
        ...
        String trimmedQuery = Util.trimString(query.toString());
        if (mOnQueryChangeListener == null || !mOnQueryChangeListener.onQueryTextSubmit(trimmedQuery)) {
            closeSearch();
            mSearchSrcTextView.setText(null);
        }
    ...
    public void setCursorDrawable(int drawable) {
        try {
            ...
            Log.e("MaterialSearchViewNew", ignored.toString());
        }
    }
