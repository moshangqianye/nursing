...
import com.jqsoft.nursing.di.ui.fragment.CityFragmentTwo;
import com.jqsoft.nursing.di.ui.fragment.DistrictFragmentTwo;
import com.jqsoft.nursing.di.ui.fragment.ProvinceFragmentTwo;
...
public class SelectTwoAddressPop extends DialogFragment implements AddressCallBackTwo {
    ...
    private ProvinceFragmentTwo mProvinceFragment;
    private CityFragmentTwo mCityFragment;
    private DistrictFragmentTwo mDistrictFragment;
...
//        view = LayoutInflater.from(context).inflate(R.layout.select_address_pop_layout,null);
        ...
        mProvinceFragment = new ProvinceFragmentTwo(context,this);
        mCityFragment = new CityFragmentTwo(context,this);
        mDistrictFragment = new DistrictFragmentTwo(context,this);
...
//            mProvinceFragment.setName(province.getAreaName());
    ...
    public void selectCity(SRCLoginAreaBean city) {
        String[] addres = new String[]{province.getAreaName(),city.getAreaName(),defutText};
        pagerTab.setTabsText(addres);
        pagerTab.setCurrentPosition(2);
        viewPager.setCurrentItem(2);
        if(city != this.city){
