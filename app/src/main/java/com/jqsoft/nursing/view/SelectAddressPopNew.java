...
import com.jqsoft.nursing.di.ui.fragment.CityFragmentNew;
import com.jqsoft.nursing.di.ui.fragment.DistrictFragment;
import com.jqsoft.nursing.di.ui.fragment.ProvinceFragmentNew;
...
public class SelectAddressPopNew extends DialogFragment implements AddressCallBack {
    ...
    private ProvinceFragmentNew mProvinceFragment;
    private CityFragmentNew mCityFragment;
...
//        view = LayoutInflater.from(context).inflate(R.layout.select_address_pop_layout,null);
        ...
        mProvinceFragment = new ProvinceFragmentNew(context,this);
        mCityFragment = new CityFragmentNew(context,this);
