...
public class FaceServer {
     ...
     *
     */
    public static void initFaceList(Context context,String faceFeatrue) {
    ...
    public static  void  inputFacefeature(String feature){
        // 内存中的数据同步
        if (faceRegisterInfoList == null) {
            faceRegisterInfoList = new ArrayList<>();
        }
        faceRegisterInfoList.clear();
        String userName = "register" == null ? String.valueOf(System.currentTimeMillis()) : "register";
        faceRegisterInfoList.add(new FaceRegisterInfo(HexUtils.hex2Bytes(feature), userName));
    }
    /**
     * 用于注册照片人脸
     *
