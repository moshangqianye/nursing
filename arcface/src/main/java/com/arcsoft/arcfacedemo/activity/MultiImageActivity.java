...
//        tvMainImageInfo = (TextView) findViewById(R.id.tv_main_image_info);
//        RecyclerView recyclerFaces =(RecyclerView) findViewById(R.id.recycler_faces);
...
//        faceEngineCode = faceEngine.init(this, FaceEngine.ASF_DETECT_MODE_IMAGE, ASF_OP_ALL_OUT,
