...
//        ConfigUtil.setFtOrient(ArcFaceForFindingActivity.this, ASF_OP_ALL_OUT);
//
...
//            if (nv21 != null) {
//                boolean success = FaceServer.getInstance().registerBgr24(ArcFaceForFindingActivity.this, nv21, bmp.getWidth(), bmp.getHeight(),
//                        "registered " );
//                if (success){
...
//                            boolean success = FaceServer.getInstance().registerBgr24(ArcFaceForFindingActivity.this, nv21.clone(), previewSize.width, previewSize.height, "registered " + faceHelper.getCurrentTrackId());
