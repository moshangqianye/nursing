...
public class ChooseFunctionActivity extends AppCompatActivity {
    ...
    private void initView() {
        //设置视频模式下的人脸优先检测方向
        RadioGroup radioGroupFtOrient = (RadioGroup)findViewById(R.id.radio_group_ft_orient);
        RadioButton rbOrient0 = (RadioButton) findViewById(R.id.rb_orient_0);
        RadioButton rbOrient90 = (RadioButton)findViewById(R.id.rb_orient_90);
        RadioButton rbOrient180 = (RadioButton)findViewById(R.id.rb_orient_180);
        RadioButton rbOrient270 = (RadioButton)findViewById(R.id.rb_orient_270);
        RadioButton rbOrientAll = (RadioButton)findViewById(R.id.rb_orient_all);
        int i = ConfigUtil.getFtOrient(this);
        if (i == FaceEngine.ASF_OP_0_ONLY) {
            rbOrient0.setChecked(true);

        } else if (i == FaceEngine.ASF_OP_90_ONLY) {
            rbOrient90.setChecked(true);

        } else if (i == FaceEngine.ASF_OP_180_ONLY) {
            rbOrient180.setChecked(true);

        } else if (i == FaceEngine.ASF_OP_270_ONLY) {
            rbOrient270.setChecked(true);

        } else if (i == FaceEngine.ASF_OP_0_HIGHER_EXT) {
