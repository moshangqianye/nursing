...
public class PhotoDialog  {
    ...
    public PhotoDialog(int a ,Context context) {
        this.mContext = context;
        this.dialogType  = a;
    }

    public PhotoDialog builder() {
        View view  = LayoutInflater.from(mContext).inflate(R.layout.dialog_photo, null);
        ...
        search_page_flowlayout = (TagFlowLayout)view.findViewById(R.id.search_page_flowlayout);
        ll_kuaijie=(LinearLayout)view.findViewById(R.id.ll_kuaijie);
        ...
        search_page_flowlayout.setOnTagClickListener(new TagFlowLayout.OnTagClickListener() {
            ...
            public boolean onTagClick(View view, int position, FlowLayout parent)
            {
                ...
                if(s1==0){
                    ...
                    mContentInput.setText(mVals[position]);
                }
    ...
    public PhotoDialog setTitle(int titleResId) {
        mIsShowTitle = true;
     ...
     * @return
     */
    public PhotoDialog setContentMsg(String msg) {
    ...
    public PhotoDialog setContentMsg(int msgResId) {
        setContentMsg(mContext.getString(msgResId));
        return this;
    }

    public PhotoDialog setCancelable(boolean cancel) {
        mDialog.setCancelable(cancel);
        return this;
    }


    public PhotoDialog setShowReason(boolean cancel){
        if(cancel){
            ll_kuaijie.setVisibility(View.VISIBLE);
        }else {
            ll_kuaijie.setVisibility(View.GONE);
        }
    ...
    public PhotoDialog setCanceledOnTouchOutside(boolean cancel) {
     ...
     * @return
     */
    public PhotoDialog setPositiveBtn(String text, final OnPositiveListener onPositiveListener) {
    ...
    /**
     * 设置确定按钮
     * @param onTakePhotoListener
     * @return
     */
    public PhotoDialog setTakePhotoBtn(final OnTakePhotoListener onTakePhotoListener) {
        takephoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (onTakePhotoListener != null) {
                    onTakePhotoListener.onTakePhoto(view);
                }
            }
        });
        return this;
     ...
     * @return
     */
    public PhotoDialog setNegativeBtn(String text, final OnNegativeListener onNegativeListener) {
    ...
    /** start----------------------------------------- */
    public PhotoDialog setTitleText(String text) {
        mIsShowTitle = true;
        if (TextUtils.isEmpty(text)) {
            mTitle.setText("提示");
        } else {
    ...
    public PhotoDialog setTitleText(int textId) {
        mIsShowTitle = true;
        mTitle.setText(textId);
        return this;
    }

    public PhotoDialog setTitleTextColor(int colorId) {
        mIsShowTitle = true;
        mTitle.setTextColor(colorId);
        return this;
    }

    public PhotoDialog setTitleTextSize(int textSize) {
        mIsShowTitle = true;
    ...
    /** start----------------------------------------- */
    public PhotoDialog setContentMsgText(String text) {
        mIsShowContentInput = true;
        if (TextUtils.isEmpty(text)) {
    ...
    public PhotoDialog setContentMsgText(int textId) {
        mIsShowContentInput = true;
        mContentInput.setText(textId);
        return this;
    }

    public PhotoDialog setContentMsgTextColor(int colorId) {
        mIsShowContentInput = true;
        mContentInput.setTextColor(colorId);
        return this;
    }

    public PhotoDialog setContentMsgTextSize(int textSize) {
        mIsShowContentInput = true;
    ...
    /** start----------------------------------------- */
    public PhotoDialog setNegativeBtnText(String text) {
        mIsShowNegativeBtn = true;
        if (TextUtils.isEmpty(text)) {
            mNegativeBtn.setText("取消");
        } else {
    ...
    public PhotoDialog setNegativeBtnText(int textId) {
        mIsShowNegativeBtn = true;
        mNegativeBtn.setText(textId);
        return this;
    }

    public PhotoDialog setNegativeBtnTextColor(int colorId) {
        mIsShowNegativeBtn = true;
        mNegativeBtn.setTextColor(colorId);
        return this;
    }

    public PhotoDialog setNegativeBtnTextSize(int textSize) {
        mIsShowNegativeBtn = true;
        mNegativeBtn.setTextSize(textSize);
        return this;
    }

    public PhotoDialog setNegativeBtnListener(final OnNegativeListener onNegativeListener) {
        mIsShowPositiveBtn = true;
        mNegativeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    /** start----------------------------------------- */
    public PhotoDialog setPositiveBtnText(String text) {
        mIsShowPositiveBtn = true;
        if (TextUtils.isEmpty(text)) {
    ...
    public PhotoDialog setPositiveBtnText(int textId) {
        mIsShowPositiveBtn = true;
        mPositiveBtn.setText(textId);
        return this;
    }

    public PhotoDialog setPositiveBtnTextColor(int colorId) {
        mIsShowPositiveBtn = true;
        mPositiveBtn.setTextColor(colorId);
        return this;
    }

    public PhotoDialog setPositiveBtnTextSize(int textSize) {
        mIsShowPositiveBtn = true;
        mPositiveBtn.setTextSize(textSize);
        return this;
    }

    public PhotoDialog setPositiveBtnListener(final OnPositiveListener onPositiveListener) {
        mIsShowPositiveBtn = true;
        mPositiveBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void initdatasing() {
        ...
        search_page_flowlayout.setAdapter(new TagAdapter<String>(mVals) {
            ...
            public View getView(FlowLayout parent, int position, String s) {
                ...
                TextView tv = (TextView) mInflater.inflate(R.layout.tv, search_page_flowlayout, false);
                tv.setText(s);
