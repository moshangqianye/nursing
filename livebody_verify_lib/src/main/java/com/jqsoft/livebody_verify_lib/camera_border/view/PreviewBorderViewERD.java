package com.jqsoft.livebody_verify_lib.camera_border.view;
 ...
 * Time: 18:03
 */
public class PreviewBorderViewERD extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public PreviewBorderViewERD(Context context) {
        this(context, null);
    }

    public PreviewBorderViewERD(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PreviewBorderViewERD(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PreviewBorderViewERD);
        try {
            tipTextSize = a.getDimension(R.styleable.PreviewBorderViewERD_tipTextSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_TIPS_TEXT_SIZE, getResources().getDisplayMetrics()));
            tipTextColor = a.getColor(R.styleable.PreviewBorderViewERD_tipTextColor, DEFAULT_TIPS_TEXT_COLOR);
            tipText = a.getString(R.styleable.PreviewBorderViewERD_tipText);
            if (tipText == null) {
