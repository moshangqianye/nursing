...
public class CameraActivity extends Activity implements View.OnClickListener {
    ...
    private com.jqsoft.livebody_verify_lib.certificateCamera.CameraPreview cameraPreview;
...
//        type = getIntent().getIntExtra("type", 0);
        ...
        setContentView(R.layout.activity_certificate_camera_live);
        cameraPreview = (com.jqsoft.livebody_verify_lib.certificateCamera.CameraPreview) findViewById(R.id.camera_surface1);
...
//        intent.putExtra("type", getCropFile().getPath());
//        bundle.putString("path", getCropFile().getPath());
