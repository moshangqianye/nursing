package com.jqsoft.appium_test.encapsulation;


import com.jqsoft.appium_test.base.AndroidDriverWait;
import com.jqsoft.appium_test.base.AssertionListener;
import com.jqsoft.appium_test.base.Builder;
import com.jqsoft.appium_test.base.ExpectedCondition;
...
public class BaseAppium {
    //调试设备名字
    public static String deviceName = "vivo X9";
    //调试设备系统版本
    public static String platformVersion = "6.0.1";
    //app路径
    public static String appPath = System.getProperty("user.dir") + "/src/main/java/apps/居民健康内部测试版V1.0.0_aligned_signed.apk";

    //包名
    public static String appPackage = "com.jqsoft.nursing";
    ...
    //要启动的Activity
    public static String appActivity = appPackage + ".di.ui.activity.LoginActivityNew";
