...
public class PictureImagePreviewFragment extends Fragment {
    ...
    public PictureImagePreviewFragment() {
    }

    public static PictureImagePreviewFragment getInstance(String url,String path, boolean isSave, String directory_path, List<LocalMedia> medias) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(path.equals("test")){
         ...
         //   String FIND_FILE_URL_BASE ="http://192.168.44.134:8080/sri";
          //  String FIND_FILE_URL_BASE =  Version.HTTP_URL;
        ...
        } else if(path ==null || path.equals("") || path.equals("null")){
//            path.substring(0,4).equals("http");
//
             String FIND_FILE_URL_BASE =path;
             String imageUrl =FIND_FILE_URL_BASE+url;
            Glide.with(container.getContext())
                    .load(imageUrl)
                    .asBitmap()
